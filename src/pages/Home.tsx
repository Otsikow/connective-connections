...
import { Home as HomeIcon, MessageSquare, Search, User, Settings } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border px-6 py-3 flex items-center justify-around">
        ...
        <button className="flex flex-col items-center gap-1 text-muted-foreground" onClick={() => navigate("/admin")}>
          <Settings size={24} />
