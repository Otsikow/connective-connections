      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 pb-16 pt-8 sm:px-10 lg:px-16">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3 text-lg font-semibold">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-slate-500 transition-colors dark:text-slate-400">Connective</p>
              <p className="text-base font-medium text-slate-700 transition-colors dark:text-slate-200">Where the right people meet</p>
            </div>
          </div>
          <nav className="hidden items-center gap-8 text-sm font-medium text-slate-600 transition-colors dark:text-slate-300 lg:flex">
            <button className="transition hover:text-slate-900 dark:hover:text-white" onClick={() => navigate("/events")}>
              Events
            </button>
            <button className="transition hover:text-slate-900 dark:hover:text-white" onClick={() => navigate("/community")}>
              Community
            </button>
            <button className="transition hover:text-slate-900 dark:hover:text-white" onClick={() => navigate("/matches")}>
              Matching
            </button>
            <button className="transition hover:text-slate-900 dark:hover:text-white" onClick={() => navigate("/login")}>
              Sign in
            </button>
            <button
          ...
          <section className="max-w-2xl space-y-10">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {stats.map((stat) => (
                ...
                >
                  <p className="text-3xl font-bold text-slate-900 transition-colors sm:text-4xl dark:text-white">{stat.value}</p>
                  <p className="mt-1 text-xs uppercase tracking-[0.2em] text-slate-500 transition-colors dark:text-slate-300/80">{stat.label}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <aside className="relative">
            ...
            <div className="relative space-y-6 rounded-3xl border border-slate-900/10 bg-white/80 p-8 shadow-2xl shadow-amber-200/20 backdrop-blur-xl transition-colors dark:border-white/15 dark:bg-slate-900/60 dark:shadow-black/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-amber-600 transition-colors dark:text-amber-200/90">Pro perks</p>
                  <h2 className="mt-2 text-2xl font-semibold text-slate-900 transition-colors dark:text-white">Unlock the full experience</h2>
                </div>
              ...
              <div className="space-y-5">
                {premiumHighlights.map((item) => (
                  <div key={item.title} className="flex gap-4 rounded-2xl border border-slate-900/10 bg-white/70 p-4 transition-colors dark:border-white/10 dark:bg-white/5">
                    ...
                    <div>
                      <p className="text-base font-semibold text-slate-900 transition-colors dark:text-white">{item.title}</p>
                      <p className="text-sm text-slate-600 transition-colors dark:text-slate-300">{item.description}</p>
                    </div>
                  </div>
                ))}
              </div>
              <div className="rounded-2xl border border-slate-900/10 bg-gradient-to-br from-amber-300/20 via-orange-300/10 to-transparent p-6 text-sm text-slate-700 transition-colors dark:border-white/10 dark:text-slate-200">
                <p className="font-semibold text-slate-900 transition-colors dark:text-white">Trust & safety comes first</p>
        ...
        <section className="mt-24 grid gap-8 lg:grid-cols-[1.6fr_1fr]">
          <div className="rounded-3xl border border-slate-900/10 bg-white/80 p-8 shadow-2xl shadow-amber-200/20 backdrop-blur transition-colors dark:border-white/10 dark:bg-white/5 dark:shadow-black/30">
            <h3 className="text-2xl font-semibold text-slate-900 transition-colors dark:text-white">Why leaders choose Connective</h3>
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-6 transition-colors dark:border-white/10 dark:bg-slate-900/60">
                ...
                <h4 className="mt-4 text-lg font-semibold text-slate-900 transition-colors dark:text-white">Curated calendar</h4>
              ...
              <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-6 transition-colors dark:border-white/10 dark:bg-slate-900/60">
                ...
                <h4 className="mt-4 text-lg font-semibold text-slate-900 transition-colors dark:text-white">Real relationships</h4>
                <p className="mt-2 text-sm text-slate-600 transition-colors dark:text-slate-300">
              ...
              <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-6 transition-colors dark:border-white/10 dark:bg-slate-900/60">
                ...
                <h4 className="mt-4 text-lg font-semibold text-slate-900 transition-colors dark:text-white">Global host network</h4>
                <p className="mt-2 text-sm text-slate-600 transition-colors dark:text-slate-300">
              ...
              <div className="rounded-2xl border border-slate-900/10 bg-white/70 p-6 transition-colors dark:border-white/10 dark:bg-slate-900/60">
                ...
                <h4 className="mt-4 text-lg font-semibold text-slate-900 transition-colors dark:text-white">Moments that stay with you</h4>
                <p className="mt-2 text-sm text-slate-600 transition-colors dark:text-slate-300">
          ...
          <div className="space-y-6">
            {testimonials.map((testimonial) => (
              ...
              >
                <p className="text-sm uppercase tracking-[0.3em] text-amber-600 transition-colors dark:text-amber-200/80">Member story</p>
                <p className="mt-4 text-lg font-semibold text-slate-900 transition-colors dark:text-white">“{testimonial.quote}”</p>
        ...
        <section className="mt-20 rounded-3xl border border-slate-900/10 bg-gradient-to-r from-amber-200/40 via-orange-200/20 to-yellow-200/30 p-10 text-slate-900 shadow-2xl shadow-amber-200/30 backdrop-blur transition-colors dark:border-white/10 dark:from-slate-900 dark:via-slate-900/90 dark:to-slate-900 dark:text-slate-100 dark:shadow-black/40">
          <div className="flex flex-col items-start gap-6 text-left sm:flex-row sm:items-center sm:justify-between sm:text-left">
            <div className="max-w-2xl space-y-3">
              <p className="text-xs uppercase tracking-[0.4em] text-slate-700 transition-colors dark:text-amber-200/80">Ready to unlock your next chapter?</p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button
                onClick={() => navigate("/signup")}
                className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-base font-semibold text-amber-200 shadow-lg shadow-slate-900/30 transition hover:scale-105 dark:bg-white dark:text-slate-900 dark:shadow-amber-100/20"
              >
                Become a member
                <ArrowRight className="h-5 w-5" />
              </button>
              <button
                ...
                className="inline-flex items-center justify-center rounded-full border border-slate-900/30 px-6 py-3 text-base font-semibold text-slate-900 transition hover:border-slate-900 dark:border-white/30 dark:text-white dark:hover:border-white"
              >
